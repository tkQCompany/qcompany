...
CommodityListGrossDialog::CommodityListGrossDialog(QDialog *parent):
    QDialog(parent), ui_(new Ui::CommodityListDialog)
{
    ui_->setupUi(this);
}

CommodityListGrossDialog::~CommodityListGrossDialog()
{
    delete ui_;
}
...
{
    if (ui_->doubleSpinBoxAmount->text().isEmpty() || ui_->doubleSpinBoxAmount->value() < 0.001)
    {
